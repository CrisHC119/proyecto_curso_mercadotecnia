<?php
    ...
    // --- CONFIGURACIÓN ESPECÍFICA UNIDAD 1 ---
    $id_examen = 1;        // ID en tabla examen_pregunta
    $id_unidad_actual = 1; // ID en tabla examen_unidad (para fechas)
    
    $puntos_totales = null;
    $examen_enviado = $_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST);
    $zonaHorariaLocal = new DateTimeZone('America/Mexico_City');
    
    // --- 1. OBTENER DATOS DEL ALUMNO (CAMPOS U1) ---
...
<div class="container py-5">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <div>
                <h4 class="mb-0 h4"><i class="bi bi-file-earmark-text-fill"></i> Examen Unidad 1</h4>
