<?php
    ...
    // --- DATOS DE SESIÓN ---
    $numeroControl = $_SESSION['nocontrol']; // Para carpetas y nombres de archivo
    $idUsuario = $_SESSION['id_usuario'];    // Para la base de datos
    ...
    try {
        ...
        // 4. Archivos físicos (Usando numeroControl)
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["eliminarArchivo"])) {
        if (!$actividadAbierta) {
            ...
            // Verificación de seguridad usando el numero de control en el nombre del archivo
                ...
                if ($cantidadAsubir > $slotsDisponibles) {
                    ...
                    for ($i = 0; $i < $cantidadAsubir; $i++) {
                        if ($_FILES["archivoActividad"]["error"][$i] == 0) {
                            ...
                            // Nombre físico con numeroControl
...
<div class="contenedor-cursos">
    <div id="mainContent">
        <h2 class="text-center mb-4"><?php echo $textos['parrafo_0963_1']; ?></h2>
        <h3><strong><p class="text-center"><?php echo $textos['parrafo_0963']; ?></p></strong></h3>
                <strong><p class="justificado"><?php echo $textos['parrafo_0874']; ?></p></strong>
        <p class="justificado"><?php echo $textos['parrafo_0964']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0876']; ?></p>
        <ul class="list-unstyled justificado mt-3">
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0965']; ?>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0966']; ?>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0967']; ?>
            </li>
        </ul>
        <strong><p class="justificado"><?php echo $textos['parrafo_0851']; ?></p></strong>
        <p class="justificado"><?php echo $textos['parrafo_0968']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0969']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0970']; ?></p>
        <ul class="list-unstyled justificado mt-3">
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0971']; ?>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0972']; ?>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0973']; ?>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0974']; ?>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0975']; ?>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0976']; ?>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0977']; ?>
            </li>
            <p class="justificado"><?php echo $textos['parrafo_0978']; ?></p>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0979']; ?>
                <p class="justificado"><?php echo $textos['parrafo_0980']; ?></p>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0981']; ?>
                <p class="justificado"><?php echo $textos['parrafo_0982']; ?></p>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0983']; ?>
                <p class="justificado"><?php echo $textos['parrafo_0984']; ?></p>
            </li>
        </ul>
        <p class="justificado"><?php echo $textos['parrafo_0985']; ?></p>
        <strong><p class="justificado"><?php echo $textos['parrafo_0857']; ?></p></strong>
        <p class="justificado"><?php echo $textos['parrafo_0986']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0987']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0988']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0989']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0990']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0991']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0992']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0993']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0994']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0995']; ?></p>
        <strong><p class="justificado"><?php echo $textos['parrafo_0865']; ?></p></strong>
        <p class="justificado"><?php echo $textos['parrafo_0996']; ?></p>
        <strong><p class="justificado"><?php echo $textos['parrafo_0867']; ?></p></strong>
        <p class="justificado"><?php echo $textos['parrafo_0997']; ?></p>
        <strong><p class="justificado"><?php echo $textos['parrafo_0869']; ?></p></strong>
        <p class="justificado"><?php echo $textos['parrafo_0998']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0999']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_1000']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_1001']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_1002']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_1003']; ?></p>
        <strong><p class="justificado"><?php echo $textos['parrafo_0841']; ?></p></strong>
        <p class="justificado"><?php echo $textos['parrafo_1004']; ?></p>
        <ul class="list-unstyled justificado mt-3">
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_1005']; ?>
            </li>
            <p class="justificado"><?php echo $textos['parrafo_1006']; ?></p>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_1007']; ?>
            </li>
            <p class="justificado"><?php echo $textos['parrafo_1008']; ?></p>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_1009']; ?>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_1010']; ?>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_1011']; ?>
            </li>
        </ul>
