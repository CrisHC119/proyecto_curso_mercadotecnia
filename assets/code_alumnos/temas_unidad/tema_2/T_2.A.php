        ...
        if (!$actividadAbierta) {
            ...
            if (strpos($archivoAEliminar, $numeroControl . '_' . $identificadorActividad . '_') === 0 && file_exists($rutaCompletaArchivo)) {
                if (unlink($rutaCompletaArchivo)) {
                    ...
                    // Si se vacía, actualizamos bit a 0
...
<div class="contenedor-cursos">
    <div id="mainContent">
        <h2 class="text-center mb-4"><?php echo $textos['parrafo_0872']; ?></h2>
        <h3><strong><p class="text-center"><?php echo $textos['parrafo_0873']; ?></p></strong></h3>
        <strong><p class="justificado"><?php echo $textos['parrafo_0874']; ?></p></strong>
        <p class="justificado"><?php echo $textos['parrafo_0875']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0876']; ?></p>
        <ul class="list-unstyled justificado mt-3">
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0877']; ?>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0878']; ?>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0879']; ?>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0880']; ?>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0881']; ?>
            </li>
        </ul>
        <strong><p class="justificado"><?php echo $textos['parrafo_0851']; ?></p></strong>
        <p class="justificado"><?php echo $textos['parrafo_0882']; ?></p>
        <ul class="list-unstyled justificado mt-3">
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0883']; ?>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0884']; ?>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0885']; ?>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0886']; ?>
            </li>
        </ul>
        <p class="justificado"><?php echo $textos['parrafo_0887']; ?></p>
        <strong><p class="justificado"><?php echo $textos['parrafo_0857']; ?></p></strong>
        <p class="justificado"><?php echo $textos['parrafo_0888']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0889']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0890']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0891']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0892']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0893']; ?></p>
        <strong><p class="justificado"><?php echo $textos['parrafo_0865']; ?></p></strong>
        <p class="justificado"><?php echo $textos['parrafo_0894']; ?></p>
        <strong><p class="justificado"><?php echo $textos['parrafo_0867']; ?></p></strong>
        <p class="justificado"><?php echo $textos['parrafo_0895']; ?></p>
        <strong><p class="justificado"><?php echo $textos['parrafo_0869']; ?></p></strong>
        <p class="justificado"><?php echo $textos['parrafo_0896']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0897']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0898']; ?></p>
        <p class="justificado"><?php echo $textos['parrafo_0899']; ?></p>
        <strong><p class="justificado"><?php echo $textos['parrafo_0841']; ?></p></strong>
        <p class="justificado"><?php echo $textos['parrafo_0900']; ?></p>
        <ul class="list-unstyled justificado mt-3">
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0901']; ?>
            </li>
            <li class="mb-3">
                <i class="bi bi-arrow-right-circle-fill text-primary me-2"></i><?php echo $textos['parrafo_0902']; ?>
            </li>
        </ul>
