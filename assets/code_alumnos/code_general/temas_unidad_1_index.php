<div class="tarjeta-curso">
    <div class="d-flex justify-content-between align-items-center mb-3 pt-2"> 
        <button class="btn btn-sm btn-outline-primary border-0" type="button" data-bs-target="#temarioCarousel" data-bs-slide="prev" aria-label="Anterior">
            <i class="bi bi-arrow-left-circle-fill fs-4"></i>
        </button>
        <h2 class="mb-0 fs-5 text-center text-primary"><?php echo $textos['temario']; ?></h2> 
        <button class="btn btn-sm btn-outline-primary border-0" type="button" data-bs-target="#temarioCarousel" data-bs-slide="next" aria-label="Siguiente">
            <i class="bi bi-arrow-right-circle-fill fs-4"></i>
        </button>
    </div>
    <div class="border-top border-primary my-2" style="height: 3px; width: 90%; margin: 0 auto;"></div>
    <div id="temarioCarousel" class="carousel slide carousel-dark" data-bs-ride="false">
        <div class="carousel-indicators mb-2">
            <button type="button" data-bs-target="#temarioCarousel" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Unidad 1"></button>
            <button type="button" data-bs-target="#temarioCarousel" data-bs-slide-to="1" aria-label="Unidad 2"></button>
            <button type="button" data-bs-target="#temarioCarousel" data-bs-slide-to="2" aria-label="Unidad 3"></button>
            <button type="button" data-bs-target="#temarioCarousel" data-bs-slide-to="3" aria-label="Unidad 4"></button>
            <button type="button" data-bs-target="#temarioCarousel" data-bs-slide-to="4" aria-label="Unidad 5"></button>
        </div>
        <div class="carousel-inner">
            <div class="carousel-item active px-2"> 
                <div class="list-group tema-lista-custom">
                    ...
                    <?php
                        $urlActividad_U1 = '/assets/code_alumnos/temas_unidad/tema_1/T_1.A.php?lang=' . $_SESSION['idioma'];
                        $linkAct_Href_U1 = $urlActividad_U1;
                        $extraAct_Class_U1 = ''; 
                        if (!${"actividadRealizada_U1"}) {
                            if (empty(${"fechaDisponible_A1"}) || empty(${"fechaLimite_A1"})) {
                                $linkAct_Href_U1 = '#';
                                $extraAct_Class_U1 = 'disabled'; 
                            } elseif (!empty(${"fechaDisponible_A1"}) && !empty(${"fechaLimite_A1"})) {
                                $zona = new DateTimeZone('America/Monterrey');
                                $ahora = new DateTime('now', $zona);
                                $inicio_A1 = new DateTime(${"fechaDisponible_A1"}, $zona);
                                $fin_A1 = new DateTime(${"fechaLimite_A1"}, $zona);
                                
                                if ($ahora < $inicio_A1 || $ahora > $fin_A1) {
                                    $linkAct_Href_U1 = '#';
                                    $extraAct_Class_U1 = 'disabled'; 
                                }
                            }
                    ...
                    ?>
                    <a href="<?php echo $linkAct_Href_U1; ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center <?php echo $extraAct_Class_U1; ?>">
                        <div>
                            <i class="bi bi-pen me-2"></i>
                            <?php 
                                echo $textos['actividad_u1']; 
                            ?>
                        </div>
                        <span class="badge bg-light text-dark fw-normal">
                            <i class="bi bi-calendar-event me-1"></i>
                            <?php echo mostrarEstadoFecha($fechaDisponible_A1, $fechaLimite_A1, ${"actividadRealizada_U1"}); ?>
                        </span>
                    </a>
                    <?php
                    ...
                    ?>
                    <a href="<?php echo $linkHref_U1; ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center mb-4 <?php echo $extraClass_U1; ?>" id="link-examen-1">
                        <div>
                            <i class="bi bi-book me-2"></i>
                            <?php 
                                echo $textos['test_u1']; 
                                if ($examenRealizado_U1) { 
                                    echo " <span class='badge bg-success rounded-pill'>Realizada</span>";
                                }
                            ?>
                        </div>
                        <span class="badge bg-light text-dark fw-normal">
            ...
            <div class="carousel-item px-2">
                <div class="list-group tema-lista-custom">
                    ...
                    <?php
                        $urlActividad_U2 = '/assets/code_alumnos/temas_unidad/tema_2/T_2.A.php?lang=' . $_SESSION['idioma'];
                        $linkAct_Href_U2 = $urlActividad_U2;
                        $extraAct_Class_U2 = ''; 
                        if (!${"actividadRealizada_U2"}) {
                            if (empty(${"fechaDisponible_A2"}) || empty(${"fechaLimite_A2"})) {
                                $linkAct_Href_U2 = '#';
                                $extraAct_Class_U2 = 'disabled'; 
                            } elseif (!empty(${"fechaDisponible_A2"}) && !empty(${"fechaLimite_A2"})) {
                                $zona = new DateTimeZone('America/Monterrey');
                                $ahora = new DateTime('now', $zona);
                                $inicio_A2 = new DateTime(${"fechaDisponible_A2"}, $zona);
                                $fin_A2 = new DateTime(${"fechaLimite_A2"}, $zona);
                                if ($ahora < $inicio_A2 || $ahora > $fin_A2) {
                                    $linkAct_Href_U2 = '#';
                                    $extraAct_Class_U2 = 'disabled'; 
                                }
                            }
                    ...
                    ?>
                    <a href="<?php echo $linkAct_Href_U2; ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center <?php echo $extraAct_Class_U2; ?>">
                        <div>
                            <i class="bi bi-pen me-2"></i>
                            <?php 
                                echo $textos['actividad_u2']; 
                            ?>
                        </div>
                        <span class="badge bg-light text-dark fw-normal">
                            <i class="bi bi-calendar-event me-1"></i>
                            <?php echo mostrarEstadoFecha($fechaDisponible_A2, $fechaLimite_A2, ${"actividadRealizada_U2"}); ?>
                        </span>
                    </a>
                    <?php
                    ...
                    ?>
                    <a href="<?php echo $linkHref_U2; ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center mb-4 <?php echo $extraClass_U2; ?>" id="link-examen-2">
                        <div>
                            <i class="bi bi-book me-2"></i>
                            <?php 
                                echo $textos['test_u2']; 
            ...
            <div class="carousel-item px-2">
                <div class="list-group tema-lista-custom">
                    ...
                    <?php
                        $urlActividad_U3 = '/assets/code_alumnos/temas_unidad/tema_3/T_3.A.php?lang=' . $_SESSION['idioma'];
                        $linkAct_Href_U3 = $urlActividad_U3;
                        $extraAct_Class_U3 = ''; 
                        if (!${"actividadRealizada_U3"}) {
                            if (empty(${"fechaDisponible_A3"}) || empty(${"fechaLimite_A3"})) {
                                $linkAct_Href_U3 = '#';
                                $extraAct_Class_U3 = 'disabled'; 
                            } elseif (!empty(${"fechaDisponible_A3"}) && !empty(${"fechaLimite_A3"})) {
                                $zona = new DateTimeZone('America/Monterrey');
                                $ahora = new DateTime('now', $zona);
                                $inicio_A3 = new DateTime(${"fechaDisponible_A3"}, $zona);
                                $fin_A3 = new DateTime(${"fechaLimite_A3"}, $zona);
                                
                                if ($ahora < $inicio_A3 || $ahora > $fin_A3) {
                                    $linkAct_Href_U3 = '#';
                                    $extraAct_Class_U3 = 'disabled'; 
                                }
                            }
                    ...
                    ?>
                    <a href="<?php echo $linkAct_Href_U3; ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center <?php echo $extraAct_Class_U3; ?>">
                        <div>
                            <i class="bi bi-pen me-2"></i>
                            <?php 
                                echo $textos['actividad_u3']; 
                            ?>
                        </div>
                        <span class="badge bg-light text-dark fw-normal">
                            <i class="bi bi-calendar-event me-1"></i>
                            <?php echo mostrarEstadoFecha($fechaDisponible_A3, $fechaLimite_A3, ${"actividadRealizada_U3"}); ?>
                        </span>
                    </a>
                    <?php
                    ...
                    ?>
                    <a href="<?php echo $linkHref_U3; ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center mb-4 <?php echo $extraClass_U3; ?>" id="link-examen-3">
                        <div>
                            <i class="bi bi-book me-2"></i>
                            <?php 
                                echo $textos['test_u3']; 
            ...
            <div class="carousel-item px-2">
                <div class="list-group tema-lista-custom">
                    ...
                    <?php
                        $urlActividad_U4 = '/assets/code_alumnos/temas_unidad/tema_4/T_4.A.php?lang=' . $_SESSION['idioma'];
                        $linkAct_Href_U4 = $urlActividad_U4;
                        $extraAct_Class_U4 = ''; 

                        if (!${"actividadRealizada_U4"}) {
                            if (empty(${"fechaDisponible_A4"}) || empty(${"fechaLimite_A4"})) {
                                $linkAct_Href_U4 = '#';
                                $extraAct_Class_U4 = 'disabled'; 

                            } elseif (!empty(${"fechaDisponible_A4"}) && !empty(${"fechaLimite_A4"})) {
                                $zona = new DateTimeZone('America/Monterrey');
                                $ahora = new DateTime('now', $zona);
                                $inicio_A4 = new DateTime(${"fechaDisponible_A4"}, $zona);
                                $fin_A4 = new DateTime(${"fechaLimite_A4"}, $zona);
                                
                                if ($ahora < $inicio_A4 || $ahora > $fin_A4) {
                                    $linkAct_Href_U4 = '#';
                                    $extraAct_Class_U4 = 'disabled'; 
                                }
                            }
                    ...
                    ?>
                    <a href="<?php echo $linkAct_Href_U4; ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center <?php echo $extraAct_Class_U4; ?>">
                        <div>
                            <i class="bi bi-pen me-2"></i>
                            <?php 
                                echo $textos['actividad_u4']; 
                            ?>
                        </div>
                        <span class="badge bg-light text-dark fw-normal">
                            <i class="bi bi-calendar-event me-1"></i>
                            <?php echo mostrarEstadoFecha($fechaDisponible_A4, $fechaLimite_A4, ${"actividadRealizada_U4"}); ?>
                        </span>
                    </a>
                    <?php
                    ...
                    ?>
                    <a href="<?php echo $linkHref_U4; ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center mb-4 <?php echo $extraClass_U4; ?>" id="link-examen-4">
                        <div>
                            <i class="bi bi-book me-2"></i>
                            <?php 
                                echo $textos['test_u4']; 
            ...
            <div class="carousel-item px-2">
                <div class="list-group tema-lista-custom">
                    ...
                    <?php
                        $urlActividad_U5 = '/assets/code_alumnos/temas_unidad/tema_5/T_5.A.php?lang=' . $_SESSION['idioma'];
                        $linkAct_Href_U5 = $urlActividad_U5;
                        $extraAct_Class_U5 = ''; 

                        if (!${"actividadRealizada_U5"}) {
                            if (empty(${"fechaDisponible_A5"}) || empty(${"fechaLimite_A5"})) {
                                $linkAct_Href_U5 = '#';
                                $extraAct_Class_U5 = 'disabled'; 
                            } elseif (!empty(${"fechaDisponible_A5"}) && !empty(${"fechaLimite_A5"})) {
                                $zona = new DateTimeZone('America/Monterrey');
                                $ahora = new DateTime('now', $zona);
                                $inicio_A5 = new DateTime(${"fechaDisponible_A5"}, $zona);
                                $fin_A5 = new DateTime(${"fechaLimite_A5"}, $zona);
                                
                                if ($ahora < $inicio_A5 || $ahora > $fin_A5) {
                                    $linkAct_Href_U5 = '#';
                                    $extraAct_Class_U5 = 'disabled'; 
                                }
                            }
                    ...
                    ?>
                    <a href="<?php echo $linkAct_Href_U5; ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center <?php echo $extraAct_Class_U5; ?>">
                        <div>
                            <i class="bi bi-pen me-2"></i>
                            <?php 
                                echo $textos['actividad_u5']; 
                            ?>
                        </div>
                        <span class="badge bg-light text-dark fw-normal">
                            <i class="bi bi-calendar-event me-1"></i>
                            <?php echo mostrarEstadoFecha($fechaDisponible_A5, $fechaLimite_A5, ${"actividadRealizada_U5"}); ?>
                        </span>
                    </a>
                    <?php
                    ...
                    ?>
                    <a href="<?php echo $linkHref_U5; ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center mb-4 <?php echo $extraClass_U5; ?>" id="link-examen-5">
                        <div>
                            <i class="bi bi-book me-2"></i>
                            <?php 
                                echo $textos['test_u5']; 
