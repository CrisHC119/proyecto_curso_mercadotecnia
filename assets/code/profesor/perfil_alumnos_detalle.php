...
<input type="text" id="nombre" class="form-control" value="<?php echo htmlspecialchars($alumno['nombres']); ?>" disabled>
        </div>
        <div>
        ...
        <div>
          ...
          <input type="text" id="apellido_m" name="apellido_m" class="form-control" value="">
        </div>
        </div>
...
<form method="POST" action="/assets/code/modelo/update_alumnos.php" onsubmit="return confirmarContraseña();">
  ...
  <button type="submit" class="btn btn-regresar"><?php echo $textos['regresar']; ?></button>
