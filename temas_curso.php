<?php
    ...
    include_once __DIR__ . '/assets/code_index/subir_temas_curso.php';
...
<script>
    document.querySelectorAll('.indice-box a[href^="#"]').forEach(anchor => {
        anchor.addEventListener('click', function (e) {
            ...
            if (targetElement) {
                document.querySelectorAll('.indice-box a').forEach(a => a.classList.remove('active-nav'));
    ...
    const observer = new IntersectionObserver((entries) => {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                ...
                document.querySelectorAll('.indice-box a').forEach(a => a.classList.remove('active-nav'));
                const activeLink = document.querySelector(`.indice-box a[href="#${id}"]`);
                if (activeLink) {
    ...
    document.querySelectorAll('.tema-seccion, .subtema-bloque').forEach(section => {
